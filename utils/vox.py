...
class Vox_util(nn.Module):
    def __init__(self, 
                 ...
                 gs_sample=0, 
                 real_size=[-25.6, 0.0, -2.0, 25.6, 51.2, 4.4], 
                 pad=None, 
                 assert_cube=False):
        ...
        self.contracted_coord=False
        self.contracted_ratio=0.667
        ...
        self.pc_range_roi = real_size  # [x_min, y_min, z_min, x_max, y_max, z_max]
    ...
    def get_voxel_grid(self, device, assert_cube=False):
        ...
        xyz_memA = basic.gridcloud3d(self.B, Z, Y, X, norm=False, device=device)  # 定义voxel大小
